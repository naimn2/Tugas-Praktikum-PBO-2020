...
public class no1 extends Application {
    ...
    Button button1;
    TextField tfAyam, tfNasi, tfAirMineral, tfSayur,tfTeh, tTotal;
    Label lAyam, lNasi, lTeh, lAirMineral,lSayur, lHAyam, lHNasi, lHTeh, lHAirMineral,lHSayur, nameRestaurant;
    Stage window;
    //Text welcome;
    ...
    public void start(Stage primaryStage) throws Exception {
        ...
        Label label = new Label("welcome to DisResto");
        ...
        button1.setOnAction(e->{
            ...
            nameRestaurant = new Label("DisResto");
            ...
            tfAirMineral = new TextField();
            //tfNasi.setPromptText("Nasi");
            tfAirMineral.setMaxWidth(30);
            lAirMineral = new Label();
            lAirMineral.setText("Air Mineral");
            lHAirMineral = new Label();
            lHAirMineral.setText("Rp. 5.000");

            tfSayur = new TextField();
            //tfNasi.setPromptText("Nasi");
            tfSayur.setMaxWidth(30);
            lSayur = new Label();
            lSayur.setText("Sayur Asam");
            lHSayur = new Label();
            lHSayur.setText("Rp. 4.000");
            ...
            submit.setOnAction(p->{
                ...
                int air = Integer.parseInt(0 + tfAirMineral.getText());
                int sayur = Integer.parseInt(0 + tfSayur.getText());
                int beli = ((ayam*12000) + (nasi*5000) + (teh*3000) + (air*5000) + (sayur*4000));
            ...
            GridPane.setConstraints(tfAirMineral, 1, 4);
            GridPane.setConstraints(lAirMineral, 2, 4);
            GridPane.setConstraints(lHAirMineral, 6, 4);
            GridPane.setConstraints(tfSayur, 1, 5);
            GridPane.setConstraints(lSayur, 2, 5);
            GridPane.setConstraints(lHSayur, 6, 5);
            GridPane.setConstraints(submit, 6, 6);
            GridPane.setConstraints(back, 6, 7);
            gridPane.getChildren().addAll(vBox2 , tfAyam, lAyam, lHAyam, tfNasi, lNasi, lHNasi, tfTeh, lTeh, lHTeh,tfAirMineral, lAirMineral, lHAirMineral, tfSayur, lSayur, lHSayur, submit, back);
