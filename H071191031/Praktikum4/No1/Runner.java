...
public class Runner {
    ...
    public static void main(final String[] args) {
        ...
        final int choose = pew.nextInt();
        if (choose == 1) {
            System.out.println("pilih bangun ruang");
            final int choose2 = pew.nextInt();
            if (choose2 == 1) {
                System.out.println();
                ...
                final Prisma prisma = new Prisma();
                ...
                final Kerucut kerucut = new Kerucut();
            ...
            final int choose3 = pew.nextInt();
            if (choose3 == 1) {
                final Persegi persegi = new Persegi();
                System.out.println("masukkan s");
                persegi.sisi = pew.nextDouble();
                System.out.println("Luas = " + persegi.Luas());
                System.out.println("keliling = " + persegi.Keliling());
            } else if (choose3 == 2) {
                final PersegiPanjang persegiPanjang = new PersegiPanjang();
                ...
                final Lingkaran lingkaran = new Lingkaran();
                lingkaran.r = pew.nextDouble();
                System.out.println("Luas = " + lingkaran.Luas());
                System.out.println("keliling = " + lingkaran.Keliling());

            } else if (choose3 == 4) {
                final Segitiga segitiga = new Segitiga();
                ...
                final Trapesium trapesium = new Trapesium();
                ...
                final JajarGenjang jajarGenjang = new JajarGenjang();
                ...
                final Layang layang = new Layang();
                ...
                final BelahKetupat belahKetupat = new BelahKetupat();
